...
- [x] إنشاء ملف translations.ts يحتوي على كل نصوص الواجهة بالعربية والإنجليزية
- [x] تحديث SettingsContext ليكشف عن hook للترجمة (useT)
- [x] تحديث صفحة الإعدادات لعرض خيارين فقط (عربي/إنجليزي) مع تغيير فوري
